...
//steps to register the house
//enum - define set of related valued
enum STEPS {
  CATEGORY = 0,
  LOCATION = 1,
  INFO = 2,
...
const RentModal = () => {
  ...
  const setCustomValue = (id: string, category: string) => {
  ...
  let bodyContent = (
    <div className="flex flex-col gap-8">
      <Heading
        title="Which description fits your place the most?"
